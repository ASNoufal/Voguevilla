...
class SkinCareUnmissabledeals extends ConsumerWidget {
  const SkinCareUnmissabledeals({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(futureskincareProvider);
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return ItemsCarousel(
                    index: index,
                    provider: futureskincareProvider,
                  );
                },
              ),
            ),
