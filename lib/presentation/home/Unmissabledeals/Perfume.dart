...
class FraganceUnmissabledeals extends ConsumerWidget {
  const FraganceUnmissabledeals({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(futurefraganceProvider);
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return ItemsCarousel(
                    index: index,
                    provider: futurefraganceProvider,
                  );
                },
              ),
            ),
