...
class WomenCarousel extends ConsumerWidget {
  const WomenCarousel({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(futureWomenShirtCarouselProvider);
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return ItemsCarousel(
                    index: index,
                    provider: futureWomenShirtCarouselProvider,
                  );
                },
              ),
            ),
