...
class MenCarousel extends ConsumerWidget {
  const MenCarousel({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(futureMenShirtCarouselProvider);
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return ItemsCarousel(
                    index: index,
                    provider: futureMenShirtCarouselProvider,
                  );
                },
              ),
            ),
