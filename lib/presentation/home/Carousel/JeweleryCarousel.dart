...
class JeweleryCarousel extends ConsumerWidget {
  const JeweleryCarousel({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(futureJeweleryCarouselProvider);
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return ItemsCarousel(
                    index: index,
                    provider: futureJeweleryCarouselProvider,
                  );
                },
              ),
            ),
