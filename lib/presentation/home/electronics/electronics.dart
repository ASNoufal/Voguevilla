...
class ElectronicsItems extends ConsumerWidget {
  const ElectronicsItems({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final data = ref.watch(futureElectronicsProvider);
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  return ItemContainer(
                    index: index,
                    provider: futureElectronicsProvider,
                  );
                },
              ),
            ),
